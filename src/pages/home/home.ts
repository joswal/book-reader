...
export class HomePage {
  ...
  ionViewDidLoad() {
    // update api key
    this.api_key_subscription = this.userDataProvider.apiKeyChanged.subscribe(
      (api_key: string) => {
    ...
    this.cleverdox_status_subscription = this.userDataProvider.cleverdoxViewerStatusChanged.subscribe(
      (status: boolean) => {
    ...
    // update platform
    this.platform_subscription = this.userDataProvider.platformChanged.subscribe(
      platform => {
    ...
    this.urls_subscription = this.paperDataProvider.historyChanged.subscribe(
      (urls: any[]) => {
